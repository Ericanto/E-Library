...
<?php
		...
		{
			$count=0;
      $res=mysqli_query($db,"SELECT * FROM `user` WHERE username='$_POST[username]' && email='$_POST[email]';");
...
<center>
      ...
      {
				mysqli_query($db,"UPDATE user SET password='$_POST[password]' WHERE username='$_POST[username]'
